...
/* ------------------------------------------------------------------ *
 * 월지(月支) 기질 — 태어난 계절이 만드는 성향
 *
 * 월지는 월령(月令)이라 불리는 가장 힘센 자리로, 곧 태어난 계절이다.
 * 격국이 "월지와 일간의 관계"를 본다면, 여기서는 월지 그 자체의 성질을 본다.
 * 절기 기준이라 인월(입춘)부터 시작해 축월(소한)로 끝난다.
 * ------------------------------------------------------------------ */

export interface MonthBranchNature {
  /** 이 달을 여는 절(節) */
  term: string;
  /** 대략적인 양력 월 */
  solarMonth: number;
...
export const MONTH_BRANCH_NATURE: Record<EarthlyBranch, MonthBranchNature> = {
  인: {
    term: "입춘",
    solarMonth: 2,
    season: "입춘은 지났지만 아직 추운 겨울이에요. 대신 땅속에서는 봄기운이 막 올라오기 시작합니다.",
    title: "느리지만 끝내 뚫고 나오는 사람",
    text: "새로 시작하는 것과 앞날을 그리는 데 마음이 가요. 순발력이나 즉각적인 결단은 느린 편이라 답답해 보일 수 있지만, 안에는 어떤 난관도 밀고 나가는 끈기와 저력이 있어요.",
    work: "무엇이든 시간이 걸리는 대신, 오래 끌고 가는 일에 강해요. 장기 계획이나 사업처럼 없는 것을 만들어내는 자리에서 잠재력이 드러납니다.",
  },
  묘: {
    term: "경칩",
    solarMonth: 3,
    season: "만물이 기지개를 켜는 완연한 봄이에요.",
    title: "가만히 있지 못하는 추진력",
    text: "늘 앞을 보고 나아가는 진취적인 성향이에요. 활동 반경을 넓히며 자기 존재를 드러내고, 겉보기와 달리 은근한 끈기와 인내심이 있어요. 집중력과 활동성이 좋아 좀처럼 포기하지 않습니다.",
    work: "기획·설계처럼 아이디어를 만들어내는 일, 창작이나 창업처럼 판을 여는 일과 잘 맞아요.",
  },
  진: {
    term: "청명",
    solarMonth: 4,
    season: "봄의 뻗어나가는 기운을 마무리하고 여름의 성장을 준비하는 때예요.",
    title: "꿈이 큰 만큼 갈등도 큰 사람",
    text: "품은 꿈과 이상이 높아서 스케일이 큽니다. 그만큼 현실과 이상 사이에서 갈등하는 시간도 길어요. 꽃을 피우기 직전의 기운이라 안에 힘이 가득 차 있습니다.",
    work: "새로운 분야를 열고 넓혀가는 일에 힘을 쏟아요. 한 가지보다 여러 갈래를 엮어 종합적인 성과를 내려는 편입니다.",
  },
  사: {
    term: "입하",
    solarMonth: 5,
    season: "꽃이 만발하는, 계절의 여왕이라 부르는 시기예요.",
    title: "화려하고 열정적인 사람",
    text: "밝고 긍정적인 사고로 주변을 살려요. 남에게 보이고 은근히 자랑하고 싶은 마음도 함께 있습니다. 꽃이 열매로 바뀌는 시점이라 결실을 위한 준비도 착실히 해둬요.",
    work: "활동적이라 밖으로 나가는 일이 잘 맞아요. 그러면서도 실속을 잘 챙기고 임기응변에 능합니다.",
  },
  오: {
    term: "망종",
    solarMonth: 6,
    season: "여름 초입, 만물이 쑥쑥 자라며 가장 화려한 때예요.",
    title: "쉬지 않고 달리는 사람",
    text: "말(馬)이 떠오를 만큼 활기가 넘쳐요. 열정을 품은 채 중단 없이 나아가는 성실한 타입이고, 거짓이 없으며 마음이 선량하고 예의가 발라요.",
    work: "성장이 마무리되는 시점이라 갈증을 자주 느껴요. 차분히 앞뒤를 살피는 수(水)의 신중함을 곁에 두면 훨씬 멀리 갑니다.",
  },
  미: {
    term: "소서",
    solarMonth: 7,
    season: "더위가 가장 기승을 부리는 한여름이에요.",
    title: "사람들과 어울려 이루는 사람",
    text: "열매가 계속 굵어지듯 삶에 대한 열정이 최고조에 이르는 때예요. 사람들과 함께 원만하고 순조롭게 풀어가려는 긍정적이고 낙관적인 마음을 지녔습니다.",
    work: "조직 안에서 사람들과 공존하며 일하는 사회성이 높아요.",
  },
  신: {
    term: "입추",
    solarMonth: 8,
    season: "더위가 물러가고 선선한 가을 기운이 도는 때예요.",
    title: "결과로 말하는 실속형",
    text: "퍼져나가던 기운이 잦아들고 결실을 맺으려는 힘이 강해져요. 빨리 끝내려는 의지가 커지는 만큼, 급할수록 차분히 따져보고 내실을 다지는 편이 좋습니다.",
    work: "시작이나 과정보다 결과에 무게를 둬요. 성실하고 부지런하며 실리를 챙깁니다. 단기간에 성취를 내는 일에 강하고, 결단력을 잘 쓰면 성과가 따라와요.",
  },
  유: {
    term: "백로",
    solarMonth: 9,
    season: "봄에 핀 꽃이 열매가 되어 온전히 거두는 수확과 풍요의 달이에요.",
    title: "빈틈을 남기지 않는 완벽주의",
    text: "결과가 다 여문 자리라 매사에 철저하고 완벽을 추구해요. 가을바람에 만물이 여물듯 생각이 많아지고, 결과를 꼼꼼히 되짚어 봅니다.",
    work: "정확도와 정밀함, 세심함과 분석력이 필요한 일에서 능력이 확실히 드러나요.",
  },
  술: {
    term: "한로",
    solarMonth: 10,
    season: "가을이 완연한 천고마비의 계절이에요.",
    title: "깊이 사색하는 사람",
    text: "지나온 뜨거운 계절을 돌아보며 사색에 잠기는 때예요. 현실과 조금 거리를 두고 감성에 젖어 인생과 철학을 생각하기 좋습니다. 고독을 즐기며 자기 정신세계에 빠져들기도 해요.",
    work: "종교·철학·의학처럼 삶과 죽음에 닿는 정신적인 분야에 관심이 많아요. 분위기를 잘 읽고 영감과 촉이 유독 발달해 있습니다.",
  },
  해: {
    term: "입동",
    solarMonth: 11,
    season: "아침저녁으로 찬 기운이 느껴지는 겨울의 문턱이에요.",
    title: "생각으로 승부하는 사람",
    text: "차분하고 지적인 사고를 지녔어요. 밖으로 드러내는 열정보다 안으로 파고드는 쪽이 편하고, 세상을 순리대로 살고자 합니다. 사고력이 남다르고 머리가 잘 돌아가요.",
    work: "학문적이고 정신적인 일에 잘 맞아요. 걱정과 염려가 쌓이기 쉬우니 땀 흘리는 운동이 몸과 마음 모두에 도움이 됩니다.",
  },
  자: {
    term: "대설",
    solarMonth: 12,
    season: "바깥은 엄동설한이지만 땅속에서는 양(陽)의 온기가 서서히 태동하는 한겨울이에요.",
    title: "겉은 차갑고 속은 따뜻한 사람",
    text: "바깥 계절 그대로, 대인관계나 일에서는 냉정하고 이성적으로 보여요. 그런데 속은 인정이 많고 따뜻합니다. 이 간극이 이 달의 가장 큰 특징이에요.",
    work: "천재적인 두뇌를 지녀서, 한 분야에 몰입하면 누구도 따라오기 힘든 집중력과 전문성을 발휘해요.",
  },
  축: {
    term: "소한",
    solarMonth: 1,
    season: "일 년 중 가장 추운 때지만, 땅속에서는 새싹을 틔우려 부단히 움직이고 있어요.",
    title: "버텨내는 힘이 가장 강한 사람",
    text: "절기가 그렇듯 강인한 인내력과 지구력을 갖췄어요. 어떤 어려움이나 난관도 끝내 넘어서는 의지와 신념이 있습니다.",
    work: "속에 따뜻한 온정이 가득해서, 힘들고 어려운 사람을 배려하고 보살피려는 마음이 커요.",
  },
};
